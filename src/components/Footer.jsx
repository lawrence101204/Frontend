export default function Footer() {
  return (
    <footer className="bg-[#d8f2dd] border-t border-green-200">
      <div
      ...
      >
        ...
        <div className="text-center sm:text-left">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 mb-4">
            <img
              ...
              className="w-16 h-16 sm:w-14 sm:h-14 rounded-full object-cover shadow-md border border-green-300"
            />
          ...
          <p className="text-sm text-gray-600 leading-6 max-w-xs mx-auto sm:mx-0">
        ...
        {/* Column 2 — Tours */}
        <div className="text-center sm:text-left">
          <h4 className="font-semibold text-gray-800 mb-3 text-lg">Tours</h4>
        ...
        {/* Column 3 — Support */}
        <div className="text-center sm:text-left">
          <h4 className="font-semibold text-gray-800 mb-3 text-lg">Support</h4>
          <ul className="space-y-2 text-sm">
            {["Contact Us", "FAQs", "Terms & Conditions", "Privacy Policy"].map(
              (item) => (
                <li
                  key={item}
                  className="text-gray-700 hover:text-green-700 hover:underline transition cursor-pointer"
          ...
          <div className="flex justify-center sm:justify-start gap-4 flex-wrap">
            {["facebook", "instagram", "youtube", "globe"].map((icon) => (
              <a
                key={icon}
                href="#"
                className="w-10 h-10 flex items-center justify-center bg-white rounded-full shadow hover:bg-green-100 transition"
              >
                {/* ICONS */}
                {icon === "facebook" && (
                  <svg
