export default function TourCard({ tour, onInquire, onViewDetails }) {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 flex flex-col justify-between">
      <div>
        <p className="text-[11px] uppercase tracking-wide text-gray-500 mb-1"></p>
        <h2 className="font-semibold text-lg">nYE</h2>
        <p className="text-sm text-gray-600">ASTIG</p>

        <div className="flex items-center gap-2 mt-3">
          <span className="text-[11px] px-3 py-[3px] rounded-full bg-[#d3ebd7] text-[#2b7a3d]"></span>
          <span className="text-[11px] px-3 py-[3px] rounded-full bg-gray-100 text-gray-700"></span>
        </div>
        ...
        <p className="mt-3 text-sm text-gray-600 line-clamp-2">
          | "Explore Old Manila with a guide..."
        </p>
      </div>
